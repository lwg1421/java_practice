package sec05_referencedatatype.array.EX09_ReadArrayData_2D;
...
public class ReadArrayData_2D {
	...
	public static void main(String[] args) {
		...
		//2 첫번째 행이 가리키는 1차원 배열의 개수
		System.out.println("첫번째 행 개수 : " + array2[0].length);
		//3 두번째 행이 가리키는 1차원 배열의 개수
		System.out.println("두번째 행 개수 : " +array2[1].length);
